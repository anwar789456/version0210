export const links = [
...

    {
        ...
        href: "/Shop",
        sublinks: [
            { title: "Bois d’olivier", href: "/Shop" },
            { title: "Fibre Naturelle", href: "/Shop" },
            { title: "Potterie", href: "/Shop" },
            { title: "Toile de jute", href: "/Shop" },
            { title: "Fouta", href: "/Shop" },
        ]
    },

    {
        ...
        href: "/Shop",
        sublinks: [
            { title: "Lampadaires", href: "/Shop" },
            { title: "Abat Jour", href: "/Shop" },
            { title: "Lustres", href: "/Shop" },
        ]
    },

    {
        ...
        href: "/Shop",
        sublinks: [
            { title: "Étagères, bibliothèques", href: "/Shop" },
            { title: "Boîtes de rangement", href: "/Shop" },
            { title: "Porte-manteaux", href: "/Shop" },
            { title: "Porte-chaussures", href: "/Shop" },
            { title: "Paniers, coffres", href: "/Shop" },
        ]
    },
